...
class Hinge:
    def __init__(self, show_images=False, is_binary=False, sharpness_factor=10, bordersize=3):
    ...
    def get_hinge_features(self, img_file):
        ...
        # save image
        # cv2.imwrite(f'./1337/bw_image{time.ctime()}.jpg', bw_image)
...
if __name__ == "__name__":
    ...
    hinge = Hinge(
        sharpness_factor=opt.sharpness_factor,
        bordersize=opt.bordersize,
        show_images=opt.show_images,
